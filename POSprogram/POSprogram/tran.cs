...
namespace PosProject
{
    ...
    class tran
    {
        ...
        private int nPriceMoney;
        private int nDiscountMoney;
        ...
        /// 해당 거래의 합계 금액
        /// </summary>
        public int m_nPriceMoney
        {
            get { return this.nPriceMoney; }
            set { this.nPriceMoney = value; }
        }
        /// <summary>
        /// 해당 거래의 할인 금액
        /// </summary>
        public int m_nDiscountMoney
        {
            get { return this.nDiscountMoney; }
            set { this.nDiscountMoney = value; }
        }
        /// <summary>
        /// 보류하지 않은 상품
        /// </summary>
